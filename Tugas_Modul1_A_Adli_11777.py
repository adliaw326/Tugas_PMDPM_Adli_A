...
model_directory = r'D:\Matakuliah Semester 5\Pembelajaran Mesin dan Pembelajaran Mendalam\Tugas_A_11777'
...
if os.path.exists(model_path):
    try:
        ...
        glucoes = st.slider("Glucose (mg/dL)", min_value=0.0, max_value=199.0, step=0.1)
        ...
        input_data = [[pregnancies, glucoes, bloodPressure, skinThickness, insulin, bmi, diabetesPedigreeFunction, age]]
    ...
    print("File 'rf_diabetes_model.pkl' tidak ditemukan di directori")